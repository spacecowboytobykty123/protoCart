...
const file_cart_cart_proto_rawDesc = "" +
	...
	"\x15STATUS_DUPLICATE_ITEM\x10\b2\xc0\x01\n" +
	"\x04Cart\x12<\n" +
...
var file_cart_cart_proto_depIdxs = []int32{
	...
	3, // 7: cart.Cart.AddToCart:output_type -> cart.AddToCartResponse
	5, // 8: cart.Cart.DelFromCart:output_type -> cart.DelFromCartResponse
	7, // 9: cart.Cart.GetCart:output_type -> cart.GetCartResponse
